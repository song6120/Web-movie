            ...
            <div class="navbar-header">
              ...
              <h1>
                <a class="navbar-brand" href="{{url('/home')}}">
                  <span class="fa fa-area-chart"></span> Webmovie<span class="dashboard_text"></span>
                </a>
              </h1>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="sidebar-menu">
                <li class="header">Quản lý website movie</li>
                <li class="treeview">
                  <a href="{{url('/home')}}">
          ...
          <div class="col_3">
            <div class="col-md-3 widget widget1">
              <div class="r3_counter_box">
                <i class="pull-left fa fa-folder-o icon-rounded"></i>
                <div class="stats">
            ...
            <div class="col-md-3 widget">
              <div class="r3_counter_box">
                ...
                <div class="stats">
                  <h5><strong>Lượt truy cập</strong></h5>
                  <span>112</span>
                </div>
              </div>
            </div>
